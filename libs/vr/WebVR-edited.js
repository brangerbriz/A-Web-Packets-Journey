 ...
 *
 * NOTE: there are numerious edits (NOTE'd with comments)
 * edits made by @nbriz in order for this to work better with VRWorld.js
 */
...
var WEBVR = {
	...
	createButton: function ( renderer, options ) {
		...
		function showVRNotFound() {
			...
			// button.onclick = null // NOTE edited
            button.onclick = ()=>{ window.location = 'https://webvr.info' };
		...
		if ( 'xr' in navigator ) {
            ...
            button.setAttribute('id','webvr-info-button') // NOTE edited
            ...
            message.setAttribute('id','webvr-info-button') // NOTE edited
